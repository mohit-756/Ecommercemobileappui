  ...
  return (
    <div className="min-h-full flex flex-col bg-white dark:bg-background lg:max-w-full lg:mx-0 lg:my-0 lg:rounded-none lg:shadow-none lg:border-none overflow-hidden transition-colors duration-300">
      <div className="bg-white dark:bg-surface pt-12 pb-4 px-6 sticky top-0 z-30 lg:pt-4 border-b border-gray-100 dark:border-border-light flex items-center">
        ...
        <h1 className="text-xl font-bold text-gray-900 dark:text-text-primary ml-2">Privacy Policy</h1>
      </div>
      ...
      <div className="flex-1 px-6 py-6 space-y-4 overflow-y-auto pb-24 text-sm text-gray-600 dark:text-text-secondary leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-gray-900 dark:text-text-primary mt-6">1. Log Files</h2>
        ...
        <h2 className="text-lg font-bold text-gray-900 dark:text-text-primary mt-6">2. Privacy Policies</h2>
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of DryFruit Hub.</p>

        <h2 className="text-lg font-bold text-gray-900 dark:text-text-primary mt-6">3. Third Party Privacy Policies</h2>
        ...
        <h2 className="text-lg font-bold text-gray-900 dark:text-text-primary mt-6">4. Children's Information</h2>
